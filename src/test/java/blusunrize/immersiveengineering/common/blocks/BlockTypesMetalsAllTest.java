...
import static blusunrize.immersiveengineering.common.blocks.BlockTypes_MetalsAll.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_MetalsAll}.
 * <p>
...
class BlockTypesMetalsAllTest
{
	...
	void ordinalsAreFrozen()
	{
		assertAll(
				...
				() -> assertEquals(9, IRON.getMeta(), "IRON moved"),
				() -> assertEquals(10, GOLD.getMeta(), "GOLD moved")
		);
	}
