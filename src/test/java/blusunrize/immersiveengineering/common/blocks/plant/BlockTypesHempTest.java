...
import static blusunrize.immersiveengineering.common.blocks.plant.BlockTypes_Hemp.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_Hemp}.
 * <p>
...
class BlockTypesHempTest
{
	...
	{
		assertAll(
				() -> assertEquals(0, BOTTOM0.getMeta(), "BOTTOM0 moved"),
				() -> assertEquals(1, BOTTOM1.getMeta(), "BOTTOM1 moved"),
				() -> assertEquals(2, BOTTOM2.getMeta(), "BOTTOM2 moved"),
				() -> assertEquals(3, BOTTOM3.getMeta(), "BOTTOM3 moved"),
				() -> assertEquals(4, BOTTOM4.getMeta(), "BOTTOM4 moved"),
				() -> assertEquals(5, TOP0.getMeta(), "TOP0 moved")
		);
	}
