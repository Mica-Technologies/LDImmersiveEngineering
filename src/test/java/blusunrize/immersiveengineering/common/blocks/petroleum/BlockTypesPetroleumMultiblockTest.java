...
import static blusunrize.immersiveengineering.common.blocks.petroleum.BlockTypes_PetroleumMultiblock.values;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_PetroleumMultiblock}.
 * <p>
 ...
 * <p>
 * Fifteen of the sixteen values block metadata allows are now used. The next addition needs a second block, not a sixteenth constant -- see the count assertion below.
 */
class BlockTypesPetroleumMultiblockTest
{
	@Test
	...
	void orderIsFrozen()
	{
		...
		String[] expected = {"derrick", "pumpjack", "distillation_tower", "industrial_burner", "gas_scrubber", "gas_turbine", "fuel_oil_boiler", "hrsg", "steam_turbine_hall", "engine_bank", "domestic_tank", "commercial_tank", "bulk_depot", "loading_gantry", "cracking_unit"};
