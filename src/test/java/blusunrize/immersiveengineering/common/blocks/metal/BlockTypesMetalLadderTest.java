...
import static blusunrize.immersiveengineering.common.blocks.metal.BlockTypes_MetalLadder.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_MetalLadder}.
 * <p>
 ...
 */
class BlockTypesMetalLadderTest
{
	@Test
	...
	{
		assertAll(
				() -> assertEquals(0, NORMAL.getMeta(), "NORMAL moved"),
				() -> assertEquals(1, COVERED_STEEL.getMeta(), "COVERED_STEEL moved"),
				() -> assertEquals(2, COVERED_ALUMINUM.getMeta(), "COVERED_ALUMINUM moved")
		);
	}
