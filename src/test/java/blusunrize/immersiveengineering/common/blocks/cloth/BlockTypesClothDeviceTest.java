...
import static blusunrize.immersiveengineering.common.blocks.cloth.BlockTypes_ClothDevice.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_ClothDevice}.
 * <p>
 ...
 */
class BlockTypesClothDeviceTest
{
	@Test
	...
	{
		assertAll(
				() -> assertEquals(0, CUSHION.getMeta(), "CUSHION moved"),
				() -> assertEquals(1, BALLOON.getMeta(), "BALLOON moved"),
				() -> assertEquals(2, STRIPCURTAIN.getMeta(), "STRIPCURTAIN moved"),
				() -> assertEquals(3, SHADER_BANNER.getMeta(), "SHADER_BANNER moved")
		);
	}
