...
import static blusunrize.immersiveengineering.common.blocks.BlockTypes_FakeLight.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_FakeLight}.
 * <p>
...
class BlockTypesFakeLightTest
{
	...
	{
		assertAll(
				() -> assertEquals(0, AIR.getMeta(), "AIR moved")
		);
	}

	@Test
	@DisplayName("no variant is listed in the creative tab")
