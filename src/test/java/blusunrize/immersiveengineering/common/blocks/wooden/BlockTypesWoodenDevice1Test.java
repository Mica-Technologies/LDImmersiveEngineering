...
import static blusunrize.immersiveengineering.common.blocks.wooden.BlockTypes_WoodenDevice1.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_WoodenDevice1}.
 * <p>
 ...
 */
class BlockTypesWoodenDevice1Test
{
	@Test
	...
	{
		assertAll(
				() -> assertEquals(0, WATERMILL.getMeta(), "WATERMILL moved"),
				() -> assertEquals(1, WINDMILL.getMeta(), "WINDMILL moved"),
				() -> assertEquals(2, WINDMILL_ADVANCED.getMeta(), "WINDMILL_ADVANCED moved"),
				() -> assertEquals(3, POST.getMeta(), "POST moved"),
				() -> assertEquals(4, WALLMOUNT.getMeta(), "WALLMOUNT moved")
		);
	}
