...
import static blusunrize.immersiveengineering.common.blocks.wooden.BlockTypes_TreatedWood.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_TreatedWood}.
 * <p>
 ...
 */
class BlockTypesTreatedWoodTest
{
	@Test
	...
	{
		assertAll(
				() -> assertEquals(0, HORIZONTAL.getMeta(), "HORIZONTAL moved"),
				() -> assertEquals(1, VERTICAL.getMeta(), "VERTICAL moved"),
				() -> assertEquals(2, PACKAGED.getMeta(), "PACKAGED moved")
		);
	}
