...
import static blusunrize.immersiveengineering.common.blocks.wooden.BlockTypes_WoodenDecoration.*;
import static org.junit.jupiter.api.Assertions.*;

/**
 * Regression guard for {@link BlockTypes_WoodenDecoration}.
 * <p>
 ...
 */
class BlockTypesWoodenDecorationTest
{
	@Test
	...
	{
		assertAll(
				() -> assertEquals(0, FENCE.getMeta(), "FENCE moved"),
				() -> assertEquals(1, SCAFFOLDING.getMeta(), "SCAFFOLDING moved")
		);
	}
