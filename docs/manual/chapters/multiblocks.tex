...
\begin{mbplan}{Substation --- three wide, two deep, two tall}{F = Substation Frame. Strike a side
face. The front rank is where power enters and leaves.}
\mblayerhot{Bottom, front rank}{F,F,F}{1}{1}\hspace{5mm}
\mblayer{Bottom, back rank}{F,F,F}\hspace{5mm}
\mblayer{Top, front rank}{F,F,F}\hspace{5mm}
\mblayer{Top, back rank}{F,F,F}
\end{mbplan}
