...
The arm is \emph{aimed} rather than jointed: one pair of keys says how high to reach, and the boom and
stick work out their own angles. It reaches roughly five blocks up, two and a half below the tracks,
and five out in front.

\begin{ietip}
The panel in the corner shows the arm's height and the fuel. Its list of controls fades away after a
few seconds --- climb out and back in to see it again.
\end{ietip}
