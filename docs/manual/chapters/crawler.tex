...
\item \textbf{Looking around slews the house} --- the cab, the counterweight and the arm all turn
      with your head, at the speed a slew ring turns rather than instantly. You cannot look around
      independently of the machine, exactly as you cannot in the real thing.
\item \textbf{R} and \textbf{C} raise and lower the arm.
\item \textbf{X} and \textbf{Z} reach out and draw back in.
\end{itemize}

It is a heavy machine and it is meant to feel like one. The throttle takes about a second to reach
full speed and rather less than that to stop; it brakes harder than it accelerates, so it does not
coast about after you have let go. It steers tightest standing still and describes an arc at speed,
which is what a skid steer does. A one-block ledge is climbed rather than bumped into, at the cost of
some of the speed you arrived with.
