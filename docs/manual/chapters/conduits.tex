...
Put an LV, MV or HV Connector --- or a Grid Feed or Service Unit --- against a \emph{bare} face and
the box breaks a free conductor out to it by itself, wearing that conductor's plate so you can see
which. That is all most circuits need; the dye is how you choose \emph{which} conductor rather than
whether there is one.

A connector on a power breakout picks up that conductor and nothing else. One bundle down a corridor
