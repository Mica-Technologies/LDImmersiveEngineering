...
Grid Feed or Service Unit, against one --- and the box breaks a free conductor out to it by itself,
wearing that conductor's plate so you can see which. That is all most circuits need; the dye is how
you choose \emph{which} conductor rather than whether there is one.
