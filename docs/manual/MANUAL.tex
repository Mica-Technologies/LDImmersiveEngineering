...
\input{chapters/wiring}
\input{chapters/generators}
\input{chapters/machines}
\input{chapters/multiblocks}
\input{chapters/logistics}
...
% ---------------------------------------------------------------------------
\part{This fork}
\input{chapters/virtual-grid}
\input{chapters/petroleum}
\input{chapters/fluid-network}
\input{chapters/conduits}
\input{chapters/crawler}
\input{chapters/city-mode}
